...
@synthesize searchBar = _searchBar ,tracksTableView = _tracksTableView;
- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view, typically from a nib.
    UINib *localNib = [UINib nibWithNibName:CellID bundle:nil];
    [localNib instantiateWithOwner:self options:nil];
    [self.tracksTableView  registerNib:localNib forCellReuseIdentifier:CellID ] ;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(cell == nil){
        cell                            =   (TrackCell*)[[UITableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:cellIdentifier];
    }
